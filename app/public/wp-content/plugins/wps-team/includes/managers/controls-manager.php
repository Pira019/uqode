...
class Controls_Manager {
	...
	/**
	 * WordPress shortcode control.
	 */
	const WP_WIDGET = 'wp_shortcode';
	...
	private static function init_tabs() {
		self::$tabs = (array) apply_filters( 'wpspeedo_team/controls/tabs', []);
	}
	...
	private static function get_default_tab() {
		return apply_filters( 'wpspeedo_team/controls/default_tab', 'general' );
	}
	 ...
	 * `wpspeedo_teamcontrols/controls_registered` action.
	 *
	 * @since 1.0.0
	 * @access private
	 */
	private function register_controls() {
		 ...
		 */
		do_action( 'wpspeedo_team/controls/controls_registered', $this );
	}
