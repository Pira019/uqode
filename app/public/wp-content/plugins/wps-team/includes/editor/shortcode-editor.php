...
class Shortcode_Editor extends Editor_Controls {
    ...
    protected function layout_section() {
        ...
        $this->add_control( 'fix_broken_words', [
            'label'       => _x( 'Fix Broken Words', 'Editor', 'wpspeedo-team' ),
            'label_block' => false,
            'type'        => Controls_Manager::SWITCHER,
            'default'     => false,
            'render_type' => 'template',
    ...
    protected function query_include_section() {
        $include_by_location = _x( 'Include by Location', 'Editor', 'wpspeedo-team' );
        $include_by_language = _x( 'Include by Language', 'Editor', 'wpspeedo-team' );
        $include_by_specialty = _x( 'Include by Specialty', 'Editor', 'wpspeedo-team' );
        $include_by_gender = _x( 'Include by Gender', 'Editor', 'wpspeedo-team' );
        $this->start_controls_section( 'query_include_section', [
            'label' => _x( 'Include', 'Editor', 'wpspeedo-team' ),
            'tab'   => 'query',
        ] );
        $this->add_control( 'include_by_group', [
            'label'       => _x( 'Include by Group', 'Editor', 'wpspeedo-team' ),
            'label_block' => true,
            'type'        => Controls_Manager::SELECT,
            'render_type' => 'template',
            'options'     => Utils::get_term_options( Utils::get_group_terms() ),
            'placeholder' => _x( 'Select Groups', 'Editor', 'wpspeedo-team' ),
            'multiple'    => true,
            'separator'   => 'none',
        ] );
        $this->add_control( 'include_by_location', [
            'label'       => $include_by_location,
            'label_block' => true,
            'type'        => Controls_Manager::UPGRADE_NOTICE,
            'separator'   => 'none',
        ] );
        $this->add_control( 'include_by_language', [
            'label'       => $include_by_language,
            'label_block' => true,
            'type'        => Controls_Manager::UPGRADE_NOTICE,
            'separator'   => 'before',
        ] );
        $this->add_control( 'include_by_specialty', [
            'label'       => $include_by_specialty,
            'label_block' => true,
            'type'        => Controls_Manager::UPGRADE_NOTICE,
            'separator'   => 'before',
        ] );
        $this->add_control( 'include_by_gender', [
            'label'       => $include_by_gender,
            'label_block' => true,
            'type'        => Controls_Manager::UPGRADE_NOTICE,
            'separator'   => 'before',
        ] );
    ...
    protected function query_exclude_section() {
        $exclude_by_location = _x( 'Exclude by Location', 'Editor', 'wpspeedo-team' );
        $exclude_by_language = _x( 'Exclude by Language', 'Editor', 'wpspeedo-team' );
        $exclude_by_specialty = _x( 'Exclude by Specialty', 'Editor', 'wpspeedo-team' );
        $exclude_by_gender = _x( 'Exclude by Gender', 'Editor', 'wpspeedo-team' );
        $this->start_controls_section( 'query_exclude_section', [
            'label' => _x( 'Exclude', 'Editor', 'wpspeedo-team' ),
            'tab'   => 'query',
        ] );
        $this->add_control( 'exclude_by_group', [
            'label'       => _x( 'Exclude by Group', 'Editor', 'wpspeedo-team' ),
            'label_block' => true,
            'type'        => Controls_Manager::SELECT,
            'render_type' => 'template',
            'options'     => Utils::get_term_options( Utils::get_group_terms() ),
