...
class Integration_Gutenberg extends Integration {
    ...
    public function editor_assets() {
        ...
        $wps_widget_block_data = array(
            'title' => __( 'WPS Team Members', 'wpspeedo_team' ),
            'description' => __( 'Display Team Members in Grid, Carousel & Filter Layouts', 'wpspeedo_team' ),
            'select_shortcode' => __( 'Select Shortcode', 'wpspeedo_team' ),
