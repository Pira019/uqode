...
class Data {
    ...
    public function register_taxonomies() {
        $taxonomies = Utils::get_taxonomy_roots();
        foreach ( $taxonomies as $taxonomy ) {
            $taxonomy_key = Utils::to_field_key( $taxonomy );
            if ( Utils::get_setting( 'enable_' . $taxonomy_key . '_taxonomy' ) ) {
                ...
                register_taxonomy( Utils::get_taxonomy_name( $taxonomy ), array(Utils::post_type_name()), $args );
            }
        }
    }
